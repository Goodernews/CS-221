...
int main(){
	...
	cout << "Root value is: " << test_tree.value<<endl;
		
	cout << "\nAdding two children and grand children" <<endl;
	test_tree.left = create_tree(12,5, create_tree(85,9), create_tree(85, 2)); 
	test_tree.right = create_tree(100, 9, create_tree(101, 3), create_tree(4, 500));
	cout << "Left node value: " << test_tree.left.value << endl;
	cout << "Right node value: " << test_tree.right.value << endl;
